...
import zhy.scau.com.personalmemo.bussiness.perform.passwordNote.PSWNoeActivity;
...
public class HomePresenter extends CommonPresenter<IHomeContract.IHomeView> implements IHomeContract.IHomePresenter {
    ...
    public void tomatoTime() {
        getActivityContext().startActivity(new Intent(getActivityContext(), PSWNoeActivity.class));
    }
